...
<%@ page import="edu.nju.studentgrade.model.Score" %>
...
<jsp:useBean id="scoreList" type="edu.nju.studentgrade.business.ScoreListBean"
scope="session" ></jsp:useBean>
<jsp:useBean id="item" class="edu.nju.studentgrade.model.Score"
