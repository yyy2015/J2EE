...
<%@ page import="edu.nju.student.grade.model.Grade" %>
...
<jsp:useBean id="item" class="edu.nju.student.grade.model.Grade"
scope="page" ></jsp:useBean>

<%
    for(int i=0;i<scoreList.getScoreList().size();i++){
        pageContext.setAttribute("item",(Grade)scoreList.getScoreList().get(i));
...
<tr>
    ...
    <%
        for(Double score : ((Grade)pageContext.getAttribute("item")).getScoreList()){
            if(score == -1.0){
